...
#conda install -y pytorch=1.10.1 torchvision cudatoolkit=10.2 -c pytorch -c nvidia ### CY
#pip install torch-scatter -f https://data.pyg.org/whl/torch-1.10.1+cu102.html ### CY
