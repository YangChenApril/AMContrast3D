...
if __name__ == "__main__":
    ...
    # pretrained_paths_unorder = glob.glob(str(pathlib.Path(cfg.pretrained_path) / '*' / '*checkpoint*' / '*_best.pth')) ### 
    # print('==', pretrained_paths_unorder) ### CY
    ...
    # print(pretrained_paths_unorder)
    # print(mn)
    for i in range(1, 7):  # 6 areas
        ...
        for pretrained in pretrained_paths_unorder:
            ...
            if f'test_area={i}' in pretrained:
                ...
                #print('pretrained_path:', pretrained_path) ### CY
                break
        ...
        '''
        ### CY (Ignore!)
        ### print(type(pretrained_path), pretrained_path)
        #for pretrained in pretrained_paths_unorder: ###
        #    pretrained_path = pretrained ###
        #cfg.pretrained_path = pretrained_path
        #print('===0', cfg.pretrained_path)
        #print(ccnn)
        # print(cfg.pretrained_path) ### CY
